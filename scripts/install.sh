...
check_file "$agents_source/luna_ba.toml" "$agents_target/luna_ba.toml"
check_file "$agents_source/luna_searcher.toml" "$agents_target/luna_searcher.toml"
...
cp "$agents_source/luna_ba.toml" "$agents_target/luna_ba.toml"
cp "$agents_source/luna_searcher.toml" "$agents_target/luna_searcher.toml"
